...
NA stands for Not avvailble, likely that the raw data has NA values in it itself and therefore can't use these to make summary statistics
...
na.rm removes NA values, removing that whole row/ data piece so are able to now make summary statistics
...
The data isn't normally distributed as the mean, median and mode aren't all the same (or even similar)
